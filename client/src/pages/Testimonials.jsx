...
const Testimonials = () => {
    ...
    const allTestimonials = [
        ...
        { name: "Amit Patel", role: "R&D Manager", text: "PINAKA TECHNOLOGIES SG PRIVATE LIMITED provided us with end-to-end support for our industrial setup. Highly recommended!", img: 13 },
        ...
        { name: "Vikram Singh", role: "Mechanical Engineer", text: "The J1 Pro IDEX is perfect for dual-material printing. PINAKA TECHNOLOGIES SG PRIVATE LIMITED's delivery was lightning fast.", img: 15 },
        ...
        { name: "Suresh Menon", role: "Manufacturer", text: "Upgrading our facility with PINAKA TECHNOLOGIES SG PRIVATE LIMITED was the best decision for our production line.", img: 19 },
        ...
        { name: "Tanya Sharma", role: "Fashion Designer", text: "3D printed accessories are the future, and PINAKA TECHNOLOGIES SG PRIVATE LIMITED makes it accessible today.", img: 22 }
    ];
    ...
    return (
        <main>
            <SEO 
                ...
                description="Hear from our community of over 10,000+ satisfied innovators and creators who use PINAKA TECHNOLOGIES SG PRIVATE LIMITED products."
                url="/testimonials"
            />
